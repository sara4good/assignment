package com.abnamro.abnAssignment;
...
import com.abnamro.abnAssignment.domain.RecipeType;
...
class RecipeIntegrationTest {
    ...
    public void setup() {
        ...
        ingredients1.add(Ingredient.builder().name("sabzi").quantity(100).build());
        ingredients1.add(Ingredient.builder().name("egg").quantity(2).build());
        ...
        ingredients1.add(Ingredient.builder().name("salmon").quantity(1).build());
        ingredients1.add(Ingredient.builder().name("oil").quantity(10).build());
    }

    @Test
    public void should_createRecipe() throws Exception {
    ...
    @Test
    public void should_find_recipe_by_id() throws Exception {
    ...
    @Test
    public void should_set_not_found__for_finding_invalidId() throws Exception {
    ...
    @Test
    public void should_get_list_of_recipes() throws Exception {
    ...
    @Test
    public void should_update_recipe() throws Exception {
    ...
    @Test
    public void should_set_not_found_for_updaiting_invalidId() throws Exception {
        recipe1.setId(1);
        mockMvc.perform(put("/api/v1/recipe/update/")
                        .content(objectMapper.writeValueAsString(recipe1))
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    @Test
    public void should_delete_existing_recipe() throws Exception {
        Recipe saved = recipeRepository.save(recipe1);
    ...
    @Test
    public void should_set_not_found_for_deleting_not_exisitng() throws Exception {
